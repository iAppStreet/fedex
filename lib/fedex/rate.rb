module Fedex
  ...
  class Rate
    ...
    #     @total_net_charge_currency #The currency used for the net charge
    ...
    attr_accessor :service_type, :transit_time, :rate_type, :rate_zone, :total_billing_weight, :total_freight_discounts, :total_net_charge_currency, :total_net_charge, :total_taxes, :total_net_freight, :total_surcharges, :total_base_charge, :total_duties_and_taxes
    def initialize(options = {})
      ...
      @total_net_charge_currency = options[:total_net_charge][:currency]
      ...
      @total_duties_and_taxes = (options[:total_duties_and_taxes]||{})[:amount]
    end
  end
end
